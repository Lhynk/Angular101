...
export class TarjetaComponent implements OnInit {
  ...
  @Input() textFromHeader: string;
  titleYes: string = "Mostrar debilidades";
  titleNo: string = "Ocultar debilidades";
  titleButton: string;

  pokemonClicked: pokemon = null;

  showPokemonClicked: boolean = false;
  ...
  constructor() { 
    this.titleButton = this.titleYes;
  }
  ...
  {
    this.showPokemonClicked = true;
    this.pokemonClicked = pokemon;
  }

  pokemonClose()
  { 
    this.showPokemonClicked = false;
  }

  pokemonWeakness(pokemon: pokemon)
  {
    pokemon.showWeakness = !pokemon.showWeakness;
  }
}
